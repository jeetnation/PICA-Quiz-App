...
<body>
	<div class="dropdwn">
		<nav>
			...
			<ul>
				<li><a href="http://localhost/PICA%20Quiz/student%20side/student_home.php">Home</a></li>
				<li><a href="#"><?php echo $_SESSION['first_name']." ".$_SESSION['last_name']; ?> <i class="fa fa-sort-desc" style="font-size:24px"></i></a>
					<ul>
							<li><a href="http://localhost/PICA%20Quiz/student%20side/student_account.php">My Account</a></li>
